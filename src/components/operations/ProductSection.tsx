...
import ProductList, { IProductListItem } from "../actual/ProductList";
import { IAppState } from "../../reducer/reducer";
import { Dispatch } from "redux";
import { connect } from "react-redux";
import { Product } from "../../Logic/Logic";
import {
  deleteProduct,
  DeleteProductAction,
  SelectAction,
...
import { IProductFormState } from "../actual/ProductForm";
...
class ProductSectionRaw extends React.Component<
...
> {
  ...
  public render() {
    const toolbox =
      this.props.activeId !== null ? (
        ...
        <small style={{ color: "bisque" }}>No product selected</small>
      );
    return (
      <div>
        <ProductList
  ...
  private getActiveProductInfo(): IProductFormState {
    ...
    const prod: IProductListItem | null =
      this.props.products.find((p) => p.id === this.props.activeId) || null;
...
const mapDispatchToProps = (
  dispatch: Dispatch<SelectAction | DeleteProductAction>,
  ownProps: any
) => {
  return {
